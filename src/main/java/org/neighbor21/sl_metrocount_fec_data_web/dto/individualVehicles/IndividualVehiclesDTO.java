package org.neighbor21.sl_metrocount_fec_data_web.dto.individualVehicles;
...
/**
 * packageName    : org.neighbor21.sl_metrocount_fec_data_web.dto.individualVehicles
 * fileName       : IndividualVehiclesDTO.java
 * author         : kjg08
 * date           : 2024-07-15
 * description    : 개별 차량 (특정 장소에 대한 개별 차량기록) 데이터를 받는 DTO 클래스입니다.
 * ===========================================================
 * DATE              AUTHOR             NOTE
 * -----------------------------------------------------------
 * 24. 7.15.        kjg08           최초 생성
